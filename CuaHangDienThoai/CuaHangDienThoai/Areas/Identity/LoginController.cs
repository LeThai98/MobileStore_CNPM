        ...
        public IActionResult Login(TaiKhoanAdmin TKAdmin)
        {
            if (ModelState.IsValid)
            {
                ...
                if (taiKhoan != null)
                {
                    ...
                    {
                        ModelState.AddModelError("", "Tài khoản X không tồn tại.");
                        //return Content("Hong Hanh");
                ...
                {
                    ModelState.AddModelError("", "Tài khoản A không tồn tại.");
                }
            }
            return View("Index");
           // return Content("Le hong thai");
        }
    }
}